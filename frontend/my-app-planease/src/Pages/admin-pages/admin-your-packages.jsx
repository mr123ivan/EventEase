...
const AdminPackages = () => {
  ...
  const fetchPackages = async () => {
    try {
      ...
      const response = await axios.get("https://api.eventsease.app/package/getall", {
        headers: {
  ...
  const fetchSubcontractors = async () => {
    try {
      const token = localStorage.getItem("token")
      const response = await axios.get("https://api.eventsease.app/subcontractor/getall", {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
  ...
  const fetchPackageServices = async (packageName) => {
    try {
      const token = localStorage.getItem("token")
      const response = await axios.get(`https://api.eventsease.app/package/getServices/${packageName}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
  ...
  const uploadPackageImage = async (packageId) => {
    ...
    try {
      ...
      const response = await axios.post(`https://api.eventsease.app/package/upload/image/${packageId}`, imageFormData, {
        headers: {
          Authorization: `Bearer ${token}`,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isEditing) {
        // Update package
        const response = await axios.put("https://api.eventsease.app/package/update", formData, {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        })
        ...
        // Create package
        const response = await axios.post("https://api.eventsease.app/package/create", formData, {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        })
        ...
        for (const service of selectedServices) {
          try {
            ...
            const addServiceResponse = await axios.post(
              "https://api.eventsease.app/package/addService",
              {
  ...
  const handleDeletePackage = async () => {
    if (window.confirm("Are you sure you want to delete this package?")) {
      try {
        const token = localStorage.getItem("token")
        await axios.delete(`https://api.eventsease.app/package/delete/${selectedPackage.packageId}`, {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        })
