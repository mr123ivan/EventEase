...
const AdminPendingRequest = () => {
    ...
    const fetchData = async () => {
        axios.get('https://api.eventsease.app/api/transactions/getAllPendingTransactions')
            .then((res) => {
  ...
  const handleSubmitDecline = async () => {
    ...
    if (refundReceipt) {
      const presignedResponse = await axios.get(`https://api.eventsease.app/bookingrejectionnote/generate-PresignedUrl`, {
        params: {
    ...
    axios
      .put(
        `https://api.eventsease.app/api/transactions/validateTransaction?transactionId=${selectedRequest?.transaction_Id}&status=DECLINED`,
        reason,
        {
          headers: {
      ...
      .then((response) => {
        ...
        axios
          .post(`https://api.eventsease.app/api/notifications/booking-rejected`, null, {
            params: {
    ...
    axios
      ...
      .then((response) => {
        ...
        if (validate === "APPROVED") {
          axios
            .post(`https://api.eventsease.app/api/notifications/booking-approved`, null, {
              params: {
                userEmail: selectedRequest?.userEmail,
                  ...
                  for (const subcontractor of selectedRequest.subcontractors) {
                    try {
                      ...
                      const response = await axios.post(
                        `https://api.eventsease.app/api/notifications/notify-subcontractors-byid`,
                        null,
                        {
                          params: {
