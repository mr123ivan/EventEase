        ...
        const client = window.google.accounts.oauth2.initTokenClient({
          ...
          callback: async (response) => {
            ...
            try {
              ...
              const checkUserResponse = await axios.get("https://api.eventsease.app/user/check-user", {
              ...
              if (checkUserResponse.data.exists) {
                ...
                const registerResponse = await axios.post("https://api.eventsease.app/user/register", registrationData)
                try {
                  await axios.post("https://api.eventsease.app/regularuser/create", { userId: registerResponse.data.userId })
                } catch (error) {
              ...
              window.FB.api("/me", { fields: "id,name,email,picture" }, async (profile) => {
                try {
                  ...
                  if (checkUserResponse.data.exists) {
                    ...
                    const registerResponse = await axios.post("https://api.eventsease.app/user/register", registrationData)
                    try {
                      await axios.post("https://api.eventsease.app/regularuser/create", {
