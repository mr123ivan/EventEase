...
const InputDetailsPagePackage = () => {
  ...
  useEffect(() => {
    const fetchPackageData = async () => {
      try {
        ...
        const response = await axios.get("https://api.eventsease.app/api/packages")
  ...
  useEffect(() => {
    const fetchAndAutoFillUserData = async () => {
      try {
        ...
        const response = await axios.get("https://api.eventsease.app/user/getuser", {
  ...
  const loadFormProgress = async (email) => {
    ...
    try {
      const response = await axios.get(`https://api.eventsease.app/form-draft/load`, {
        headers: { Authorization: `Bearer ${token}` },
        params: {
          email: email,
  ...
  const submitFormProgress = () => {
    ...
    console.log(body)
    axios.post(`https://api.eventsease.app/form-draft/save`, body, {
      headers: { Authorization: `Bearer ${token}` },
    })
    .then((response) => {
      console.log(response.data)
