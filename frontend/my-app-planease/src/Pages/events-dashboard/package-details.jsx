  ...
  useEffect(() => {
    const fetchPackageData = async () => {
      try {
        ...
        const packageResponse = await axios.get(`https://api.eventsease.app/package/get/${package_id}`, {
          headers: {
        ...
        try {
          const serviceAttachmentsResponse = await axios.get(`https://api.eventsease.app/package/service/${package_id}`, {
            headers: {
              Authorization: `Bearer ${token}`,
            },
          })
        ...
        const allPackagesResponse = await axios.get("https://api.eventsease.app/package/getall", {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        })
